...
=== "v4.5.1 and Later"
    ...
    ![RealHomes Settings - Copyrights](images/customize-theme/footer-copyright-ultra-settings.png)
...
=== "v4.5.0 and Earlier"
    ...
    ![Legacy Customizer - Text Settings Ultra](images/footer/footer-text-settings-ultra.png)