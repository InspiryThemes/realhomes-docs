...
You can customize the login dialog box. Follow the navigation path based on your version of the **RealHomes** theme:
...
!!! note
    Dialog box will appear if no page is selected in the **Login and Register Page (optional)** field.
...
You can also redirect the users once they have logged in. The settings are found in the same **Login & Register** section mentioned above.
