To configure the following settings, navigate based on your version of the **RealHomes** theme:
...
You can add a logo for the dashboard in:
...
=== "v4.5.0 and Earlier"
    ...
    !!! info "Legacy Settings"
        <span class="nav-step">Dashboard</span> ➤ <span class="nav-step">RealHomes</span> ➤ <span class="nav-step">Customize Settings</span> ➤ <span class="nav-step">Site Identity</span>
...
=== "v4.5.1 and Later"
    ...
    ![Dashboard Page Greeting Text for Logged-in User](images/dashboard/dashboard-greeting-text-settings.png)
