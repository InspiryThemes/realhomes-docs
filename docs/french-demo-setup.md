# French Demo Setup Guide

!!! info "About French Demo"
    The **French Demo** was introduced in **RealHomes v4.5.0** and you can check it out live [here](https://demo.realhomes.io/french).  
...
### 🛠️ **Importing the French Demo**

To import the **French Demo content**, follow these steps:
...
2. Click the **Language** tab and then click the blue **Import Demo** button under the **Français Ultra - Elementor** option.
...
4. The import process will begin. It may take a few minutes to complete as images and data are fetched from the server.
   ...
   ![French Demo Import Process](images/import-demo/french-demo-import.png)
...
Now visit your website — it should look exactly like the **[French Demo](https://demo.realhomes.io/french)**.
