# Spanish Demo Setup Guide

!!! info "About Spanish Demo"
    The **Spanish Demo** offers a localized experience for Spanish-speaking regions. You can check it out live [here](https://demo.realhomes.io/spanish).  
...
### 🛠️ **Importing the Spanish Demo**

To import the **Spanish Demo content**, follow these steps:
...
2. Click the **Language** tab and then click the blue **Import Demo** button under the **Spanish Modern - Elementor** option.
...
4. The import process will begin. It may take a few minutes to complete as images and data are fetched from the server.
   ...
   ![Spanish Demo Import Process](images/import-demo/spanish-demo-import.png)
...
The Spanish Demo is fully localized, including translations for core property fields, taxonomies, and dummy content. This demonstrates how RealHomes can be easily adapted for the Spanish-speaking real estate market.
...
Now visit your website — it should look exactly like the **[Spanish Demo](https://demo.realhomes.io/spanish)**.
