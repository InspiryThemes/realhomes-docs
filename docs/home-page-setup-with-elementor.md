...
Since version 3.8.0, you get **Elementor Page Builder** with **RealHomes Theme main** package so you can add the  content easily using Elementor Page Builder. It comes with **35 Elementor Custom Widgets of RealHomes Theme** which means you will find 35 custom widgets in Elementor's panel with lots of customizable options and settings.
