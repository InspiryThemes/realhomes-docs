...
=== "v4.5.1 and Later"
    ...
    ![RealHomes Settings - Footer Layout](images/footer/footer-layout-ultra-settings.png)
...
=== "v4.5.0 and Earlier"
    ...
    ![Legacy Customizer - Footer Layout Ultra](images/footer/footer-layout-settings-ultra.png)