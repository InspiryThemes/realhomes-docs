# CRM Demo Setup Guide

!!! info "About CRM Demo"
    The **CRM Demo** was introduced in **RealHomes v4.5.0** and you can check it out live [here](https://ultra.realhomes.io/crm).  
...
### 🛠️ **Importing the CRM Demo**

To import the **CRM Demo content**, follow these steps:
...
2. Click the blue **Import Demo** button under the **CRM - Ultra Elementor** option.
...
4. The import process will begin. It may take a few minutes to complete as images and data are fetched from the server.
   ...
   ![CRM Demo Import Process](images/import-demo/crm-demo-import.png)
...
Now visit your website — it should look exactly like the **[CRM Demo](https://ultra.realhomes.io/crm)**.
