# Hebrew Demo Setup Guide

!!! info "About Hebrew Demo"
    The **Hebrew Demo** was introduced in **RealHomes v4.5.0** and you can check it out live [here](https://demo.realhomes.io/hebrew).  
...
### 🛠️ **Importing the Hebrew Demo**

To import the **Hebrew Demo content**, follow these steps:
...
2. Click the **Language** tab and then click the blue **Import Demo** button under the **Hebrew Ultra - Elementor** option.
...
4. The import process will begin. It may take a few minutes to complete as images and data are fetched from the server.
   ...
   ![Hebrew Demo Import Process](images/import-demo/hebrew-demo-import.png)
...
The Hebrew Demo comes with full **Right-to-Left (RTL)** support, making it ideal for Hebrew-speaking audiences. All layouts, text alignment, and UI elements are properly mirrored for a seamless RTL experience.
...
Now visit your website — it should look exactly like the **[Hebrew Demo](https://demo.realhomes.io/hebrew)**.
